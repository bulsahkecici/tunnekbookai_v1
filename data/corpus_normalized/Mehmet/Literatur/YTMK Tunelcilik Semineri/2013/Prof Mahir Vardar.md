---
document_id: "DOC000132"
title: "Prof Mahir Vardar"
source_file: "Prof Mahir Vardar.pdf"
source_relative_path: "Mehmet/Literatur/YTMK Tunelcilik Semineri/2013/Prof Mahir Vardar.pdf"
source_extension: ".pdf"
sha256: "c736114ad7d9ac29557c038d3125645cc50104cd1bb39ff873388c1f65c5ccbe"
language: null
...
## Prof.Dr. Mahir VARDAR İ stanbul Teknik Üniversitesi Prof.Dr. Mahir VARDAR

## DÜNYADA VE TÜRKİYEDE TÜNELC İ L İ K VE YERALTI GEÇ İŞ LER İ

Prof. Dr. Mahir VARDAR

TÜRKİYE TÜNELC İ L İ K SEM İ NER İ 13 Haziran 2013
...
ÜÇ BOYUTLU B İ R TEKN İ K S İ STEM dir.
...
## Tünellerdeki Mühendislik Hizmetleri Tünellerdeki Mühendislik Hizmetleri

- 1) iyileştirme:

## Başlıca Önlemler

Mekanik davranışı yetersiz olan birimleri iyi (nitelikli) hale getirmek

- 2) Sağlamlaştırma:
- 3) Destekleme:

Gerilme durumunu olumlu yönde değiştirmek ve geliştirmek amacıyla (genelde iyileştirmeyle birlikte) önlem aÍmak

- Hareketi engelleyici yapisal önlemler almak, tutucu kuvvet uygulamak
- 4) Dengeleme-Düzenleme:

Olası hareketleri ve riskleri giderme amaciyla arazi geometrisini ve/veya malzeme yayılımını denetlemek

- 5) Koruma:

Mevcut ya da oluşturulan ortam niteliklerinin ve koşulların değişmémesi için olumsuz etkilere karşı önlem almak

- 6) Güvenlik arttırma:

Teknik ve psikolojik amaçla, zorunlu olmadığı halde ek önlemler almak

## 7) Uyumlandirma:

Başta doğaya uygunluk olmak üzere, tarihsel ve kentsel doku ve mimariye uýgun tasarımlar yapmak
...
| TÜNEL                                                   | Tarih     |   uzunluk [m] |   Kazı Miktarı [m³] | Açıklama                                              |
|---------------------------------------------------------|-----------|---------------|---------------------|-------------------------------------------------------|
| Malpas Tunnel Canal Languedoc, Fransa                   | 1679-1681 |           157 |               9.300 | Tüfler içinde ilk kara barut kullanımı                |
| Hare-Castle Tunnel Trend and Mersey Channel, ingiltere  | 1777      |         2.600 |              24.000 | ingiltere'nin ilk SUYOLU Tüneli                       |
| Galerie de Tranquoi, Canal de St. Quentin, Fransa       | 1803      |         1.098 |              30.000 | Baskılı kayada 8m açıklıklı ilk Tünel 8 parçalı kazı, |
| Standedge Tunnel Huddersfield Narrow Channel, ingiltere | 1811      |         5.000 |              70.200 |                                                       |
...
## Tünel projelerinde bölgelendirme Project zones of a tunnel

```
A: SI TüNEL veya GiRi$ BÖLGESi Shallow tunnel or portal area HOMOJEN BÖLGELER B: YüZEYE YAKIN TüNEL ve FAY ZONLARI (2D<H<4D) h1 - hs , f : Near surface tunnel Homogeneous Zones C: AZ DERiN,DERiN,COK DERiN TüNEL (H>>4D) and Fault Zones Nearly deep,deep,very deep tunnel
```
...
DÜNYADA VE TÜRKIYEDE TÜNELCILIK

TÜRKiYE TÜNELCiLiK SEMiNERi / 13 Haziran 2013– M. VARDAR
...
DYNEPRPETROVSK METROSU YAPILAB İ L İ RL İ K VE MAL İ YET DE Ğ ERLEND İ RMESi - VARDAR 5 Nisan 2013
...
| Çelik Hasir                      | Püskürtme Beton PB   | Saplama SN BIon               | iksa      | invert                    |
|----------------------------------|----------------------|-------------------------------|-----------|---------------------------|
| Q188/188 10 cm C 25 (221/221) B1 | Φ26,3m               | I 120 + 5 cm PB 12 adet işBAN | HER ZAMAN | Q188/188, I 120, 15 cm PB |
| HER ZAMAN                        |                      | I 120 + 5 cm PB 12 adet işBAN |           | Q188/188, I 120, 15 cm PB |
| GE RE K T IČIN D E A2            | HER ZAMAN            | GEREKTIČINDE                  |           | Q188/188, I 120, 15 cm PB |
| B2                               |                      |                               |           | HER ZAMAN                 |
| B3                               |                      |                               |           |                           |
...
## Geomekanik Parametreler ve Primer Gerilme Durumu Geomekanik Parametreler ve
...
## Başlıca Yapım Öğeleri ve Önlemleri

- iyileştirme Öğeleri ve Önlemleri 1) Mekanik davranışı yetersiz olan birimleri iyi (nitelikli) hale getirmek (enjeksiyon, drenaj, kompaksiyon, konsolidasyon)
- Gerilme durumunu olumlu yönde değiştirmek ve geliştirmek amaciyla (genelde iyileştirmeyle birlikte) önlem almak (ankraj, püskürtme beton, çelik hasır vbg.)
- 2) Sağlamlaştırma Öğeleri ve Önlemleri
- 3) Destek Öğeleri ve Önlemleri Hareketi engelleyici yapisal önlemler almak, tutucu kuvvet uygulamak (istinat duvārı)
- 4) Dengeleme-Düzenleme Öğeleri ve Önlemleri Şev ve yamaçların eğimini değiştirmek, yük kadırmak, topuğu yüklemēk, basamaklandırmak(palye ve berme)
- 5) Koruma Yüzey drenajı, yüzey kaplaması (Püskürtme Beton), yüzey ağları, tel örgü, geogrit örtü, bitkilendirme
- Gergiler, tel çitler, yutucu-soğurucu hendekler, siçrama perdeleri
- 6) Güvenlik arttırıcı önlemler
- 7) Uyumlandırma Şev yüzeylerini kullanan ve tarihi-kentsel dokuyu bozmayan, zenginleştiren mimari tasarımlar oluşturmak ve Peysaj uygulamak
...
öngörüldü ğ ünden daha farkl ı ş imal edilirler.
