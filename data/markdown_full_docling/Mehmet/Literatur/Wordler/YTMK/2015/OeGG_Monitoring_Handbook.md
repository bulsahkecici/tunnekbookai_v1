...
- 4.9. Water level gauges and Piezometers	33
- 4.9.2. Installation requirements	34
- 4.9.3. Accuracy requirements	34
- 4.10.2. Vibrating wire sensors	35
- 4.10.3. Fibre optic sensors	36
- 4.10.4. Installation requirements	36
- 4.12.2. Digital ground mapping	40

- 4.9.1. Types of piezometers	34

- 4.10.1. Strain meters	35

- 4.11.1. Installation requirements	38

- 4.12.1. Manual structure mapping	38

5. **Evaluation, presentation and interpretation of monitoring data	42**
    - 5.1. General displacement development	42
    - 5.2. 3D displacement monitoring	43
        - 5.2.1. Time - displacement diagram	43
        - 5.2.2. Distance - displacement diagram	43
        - 5.2.3. Assessment of stabilization	43
        - 5.2.4. Displacement development prediction model	48
        - 5.2.5. Displacement vectors in longitudinal and cross section	52
        - 5.2.6. State line (deflection curve) diagrams and trend lines	55
        - 5.2.7. Evaluation of displacement differences or ratios	57
        - 5.2.8. Displacement vector orientation plot in stereonet	63
        - 5.2.9. Stress intensity in a shotcrete lining	64
        - 5.2.10. Surface displacements	65
        - 5.2.11. Value of evaluation methods	66
    - 5.3. Extensometers	68
    - 5.4. Piezometers	69
    - 5.5. Strain Gauges	70
    - 5.6. Borehole Inclinometers	72
    - 5.7. Invert Probe	73
    - 5.8. Discontinuity location and orientation	74
        - 5.8.1. Data acquired manually	74
        - 5.8.2. Data from contact free measurements	75
        - 5.8.3. Analysis	76
6. **Geotechnical safety management plan	77**
    - 6.1. Basics	77
    - 6.2. Contents	77
        - 6.2.1. Contact details	77
        - 6.2.2. Responsibilities	77
        - 6.2.3. Geotechnical Meetings	77
...
- 6.2.4. Observation program	78
- 6.2.5. Definition of expected system behaviour (target behaviour)	78
- 6.2.6. Action levels	78
- 6.2.7. Warning levels	79
- 6.2.8. Organisation and communication	82
### 1 References	86
...
| Hazard                                                                                                                                                                                                                                 | Due to                                                   | Observation Variables   |            |                                                       |                        |                    |                  |                      |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|-------------------------|------------|-------------------------------------------------------|------------------------|--------------------|------------------|----------------------|
|                                                                                                                                                                                                                                        |                                                          | Surface settlements     | Tilt angle | Support displacement / strains /  utilisation / state | Water table / pressure | Face displacements | Ground structure | Ground displacements |
...
|                                                                                                                                                                                                                                        | Swelling ground                                          | -                       | -          | ■                                                     | ■                      | -                  | -                | ■                    |
| - very valuable  □ limited value  - no value  * - is also associated with the occurrence of excessive deformations, however asymmetric deformations along the systematic weakness planes predominantly influence the system behaviour. |                                                          |                         |            |                                                       |                        |                    |                  |                      |
...
| - very valuable  □ limited value  - no value  * - possible with computer-based interpolation and evaluation methods |                                       |                                |             |                |             |              |                                |                          |               |                     |                 |                |                                 |                          |                     |

Austrian Society for Geomechanics

- 3.4. **Organisation and management of the monitoring project**
2. Prediction and assessment of the system behaviour are essential elements of the detail design and thus should be executed by the designer
3. Development of the monitoring plan and its update is responsibility of the designer
4. Evaluation and analysis of the monitoring data, as well as of all other relevant infor- mation have to be done without delay by geotechnically qualified personnel, and the results made available to all parties involved as soon as possible
5. The processed monitoring data and other relevant information shall be stored on a powerful IT device, and made available to all parties involved in the project
6. Technical and organizational provisions should guarantee that data evaluation is rapid enough to allow for successful implementation of mitigation measures
7. All steps of the process (measurement, evaluation, interpretation, recommendation of mitigation measures, decision, supervision of execution) shall be documented
...
###### 1 Typical distances between monitoring sections
...
- 3.5.1.1.1. deformation of surface, buildings, and utilities
- 3.5.1.1.2. water table drawdown
- 3.5.1.1.3. face stability
- 3.5.1.1.4. lining displacements and integrity Instrumentation:
...
- 3.5.1.1.4.1. ground structure
- 3.5.1.1.4.2. discontinuity location and orientation in relation to the tunnel alignment Instrumentation: geological compass and/or digital ground mapping
...
4. ground structure Instrumentation:
...
- 4.2. mineralogical composition (swelling clays and minerals)
- 4.3. lining condition, deformation and strains
- 4.4. ground displacements
...
|--------------------------------|-------------|--------------------|--------------------|--------------------|
| Tunnel  (dia: tunnel diameter) | a           | 2dia+X  1  (2+n)MS | and                | min.               |
|                                | b           | 3dia+X  2  (3+n)MS | and                | min.               |
|                                | c           | 5dia+X  3  (5+n)MS | and                | min.               |
| surface                        | d           | dia+OB+X  4        |                    |                    |
| surface                        | e           | 3dia+X  5          |                    |                    |
| surface                        | f           | 5dia+X  6          |                    |                    |
| surface                        | g           | 1,5dia+OB+X  7     |                    |                    |
| surface                        | h           | 3dia+2OB+X  8      |                    |                    |
...
###### 5 Buildings, utilities, traffic infrastructure
...
###### 6 Measurements during additional mining activities
...
###### 9 Arrangement of monitoring displacement targets
...
2. The system accuracy shall be better than 1 mm per 10 m measuring length
3. Measuring range: vertical or horizontal: +/- 30° (10° for in-place inclinometers)

#### 1.1 Water level gauges and Piezometers
...
- 0.2. % in tension. They should be temperature compensated to account for temperature in- crease of the shotcrete during the hydration process.
2. The system accuracy shall be better than ± 1 % of full scale

##### 1.2.2 Vibrating wire sensors
...
- 4.9. **Measurements of discontinuity location and orientation**
...
##### 1.3.2 Manual structure mapping
...
In the case of tunnel face mapping, it is generally sufficient to map geologic structures in the sub-centimetre range. Assuming the sectional area of a tunnel being about 60 m 2 and it is pho- tographed with an 18 MPix camera, a resolution of 3-5 mm/pixel and a positional accuracy error in the same range can be expected. With LiDAR similar resolution can be achieved.
...
### 2 EVALUATION, PRESENTATION AND INTERPRETATION OF MONITORING DATA
...
#### 2.1 General displacement development

Figure 37 depicts a typical radial displacement development. The Z 0 -line represents the total displacements caused by the excavation of a tunnel. The total displacements consist of the displacement occurring ahead of the face (Zp 0 ), the displacement occurring between excava- tion and zero reading (Zp 1 ), and the monitored displacements after zero reading (Z m =Z 1 ).
...
#### 2.2 3D displacement monitoring
...
##### 2.2.1 Time - displacement diagram
...
##### 2.2.2 Distance - displacement diagram
...
##### 2.2.3 Assessment of stabilization
...
###### 2.2.3.2 Changing advance rate and construction stops
...
###### 2.2.3.4 Influence of the support installation
...
##### 2.2.4 Displacement development prediction model
...
30 th significant deviations from the predicted behaviour appeared, showing progressive in- crease in the settlement rates.
...
##### 2.2.5 Displacement vectors in longitudinal and cross section
...
##### 2.2.6 State line (deflection curve) diagrams and trend lines
...
##### 2.2.7 Evaluation of displacement differences or ratios
...
###### 2.2.7.1 Same component in different monitoring points
...
###### 2.2.7.2 Different components in one monitoring point
...
###### 2.2.7.3 Combination of different trends
...
##### 2.2.8 Displacement vector orientation plot in stereonet
...
##### 2.2.9 Stress intensity in a shotcrete lining
...
##### 2.2.11 Value of evaluation methods
...
|-----------------------------------------------------------------------------|-----------------------|-----------------------------|----------------------------------|-------------------------------------------------------|--------------------------|-------------------------------------|
|                                                                             | Stabilisation process | Prediction of displacements | Stress distribution longitudinal | Detection of weak zones outside pro- file; kinematics | Prediction ahead of face | Estimate of lining stress intensity |
| Time-displacement                                                           | ■                     | ■                           | -                                | □                                                     | -                        | ■                                   |
...
#### 2.8 Discontinuity location and orientation

##### 2.8.1 Data acquired manually
...
##### 2.8.2 Data from contact free measurements
...
### 3 GEOTECHNICAL SAFETY MANAGEMENT PLAN
...
- 4.9.1. **Definition of expected system behaviour (target behaviour)**
...
|         | **b**   | Imminent danger; risk also affects third parties; crisis situation                              |
...
2. Ensure safety of persons involved in the project
3. Ensure stability of structure
...
###### 3.2.4.2 Data collection, communication centre and management of integrated pro- cess
...
| Element   |             | Measuring section                                                                                                              | Warning and alarm level   | Warning and alarm level   | Warning and alarm level   | Warning and alarm level   | Warning and alarm level   | Geotech- nical ex- planation   | Required measures                    |
|-----------|-------------|--------------------------------------------------------------------------------------------------------------------------------|---------------------------|---------------------------|---------------------------|---------------------------|---------------------------|--------------------------------|--------------------------------------|
|           |             |                                                                                                                                | 0                         |                           | 1                         |                           | 2                         | Geotech- nical ex- planation   |                                      |
|           |             |                                                                                                                                | normal                    | devia- tion               | devia- tion               | critical                  |                           |                                |                                      |
...
| Lot A1    | Underground |                                                                                                                                |                           |                           |                           |                           |                           |                                |                                      |
| Lot A1    | Underground |                                                                                                                                |                           |                           |                           |                           |                           |                                |                                      |
| Lot A1    | Underground | Geotechnical Explanation:  1. strong asymmetric displacements (left sidewall larger), ….. 2. increase in crown settlements, …… |                           |                           |                           |                           |                           |                                |                                      |
...
###### 3.2.4.4 Design of corrective measures
...
**Behaviour as expected Continue as planned**

**Discussion ENG and GE**

**Information of ENG**

**Observations relevant for safety**
...
| **Criteria warning level 1 reached**                                                                                                                                                |                                                                         | **Criteria warning level 2a reached**  **third parties not afffected**                                    | **Criteria warning level 2b reached**  **third parties afffected**                                                                          |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
...
|                                                                                                                                                                                     | Management of crisis by ENG until takeover by CM, resp. Owner  optional |                                                                                                           |                                                                                                                                             |
...
1. Guideline for the geotechnical design of underground structures (2010). Salzburg: OeGG,
...
5. Geomonitoring GMS.NeVi; KOPA - Korschineck &amp; Partner Vermessung ZT-GmbH, [http://www.kopa.at](http://www.kopa.at/)
...
15. Schubert, W., Moritz, B. (2011). State of the art in evaluation and interpretation of dis- placement monitoring data in tunnels. Geomechanics and Tunnelling 4, No. 5, Berlin:
...
18. Barlow, J.P. (1986). Interpretation of Tunnel Convergence Measurements. MSc Thesis,
...
20. Sellner, P., Grossauer, K., Schubert, W. (2002). Advanced Analysis and Prediction of Dis- placements and System Behaviour in Tunnelling. In: Dinis da Gama, C. &amp; Ribeiro e Sousa,
...
21. Geofit, [http://www.geofit.3-g.at](http://www.geofit.3-g.at/)
...
23. Klopčič, J. (2009). Analysis and Prediction of Displacements for Tunnels built in foliated Rock Mass of Perm-Carboniferous Age. PhD thesis, University of Ljubljana, Slovenia
24. Davila Mendez, J. (2013). Analysis of Displacements in Foliated Rock Masses. In: Mozafa- ri, Hashemi (eds), Underground Spaces and Millennium Development Goals, ITC, 2013,
...
26. Schubert, P., Klopčič, J., Štimulak, A., Ajdič, I., Janko, L. (2005). Analysis of Characteristic Deformation Patterns at the Trojane Tunnel in Slovenia. Felsbau 23, No. 5, pp. 25-30, Es- sen: VGE

[27} Schubert, W. (2010). Lecture notes: Interpretation of displacement monitoring data.

Course NATM Engineer, unpublished

28. Vavrovsky, G.M., Ayaydin, N. (1988). Bedeutung der vortriebsorientierten Auswertung geotechnischer Messungen im oberflächennahen Tunnelbau. Forschung und Praxis, Band
...
36. Leber, C., Radončić, N., Schubert, W. (2009). Influence of the primary stress state on the displacement characteristic. In Vrkljan (ed), Rock Engineering in difficult ground condi- tions, soft rocks and karst, pp. 471-476. London: Taylor&amp;Francis
...
40. ÖGG. NATM - The Austrian Practice of Conventional Tunnelling. (2010). Salzburg: OeGG,
...
42. Lenz, G. (2007). Displacement Monitoring in Tunnelling – Development of a semiauto- matic evaluation system. Diploma Thesis, Institute for Rock Mechanics and Tunnelling,
...
47. Hellmich, C., Macht, J., Mang, H.A. (1999). Ein hybrides Verfahren zur Bestimmung der Auslastung von Spritzbetonschalen auf der Basis von In-situ-Verschiebungsmessungen und thermo-chemo-mechanischer Materialmodellierung. Felsbau 17, No. 5, pp. 422-425,
...
57. Tunnel:Monitor; [http://www.tunnelmonitor.com](http://www.tunnelmonitor.com/)
...
H.: [www.OEGG.at](http://www.oegg.at/)

E.: [Salzburg@OEGG.at](mailto:Salzburg@OEGG.at)
